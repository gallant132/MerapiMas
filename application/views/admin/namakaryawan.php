      ...
      <div class="main-content">
        <section class="section">
          ...
          <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" 
                                        ...
                                        <?php $no= 0; ?>
                                            <?php foreach ($karyawan as $key): ?>
                                              <?php $no++?>
                                                ...
                                                <td>
                                                    <button class="btn btn-primary text-white mb-2"> <?php echo anchor('admin/namakaryawan/edit_karyawan/'.$key->id_karyawan,'<font color=white > Ubah </font>'); ?> </button>
                                                    ...
                                                    <button class="btn btn-danger text-white mb-2" role="button" id="delete-button"> <?php echo anchor('admin/namakaryawan/hapus_karyawan/'.$key->id_karyawan,'<font color=white  onclick=”return confirm(‘Yakin Hapus?’)” > Hapus </font>'); ?> </button>
                                                </td>
                        ...
                        <a class="nav-link page-scroll active btn btn-success" href="<?= base_url("admin/namakaryawan/tambah_karyawan/")  ?>">Tambah Data</a>
                        </ol>
        </section>
      </div>
      <!-- footer -->
