      ...
      <div class="main-content">
        <section class="section">
          ...
          <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" 
                                    ...
                                    <tr role="row" class="odd">
                                        <?php $no= 0; ?>
                                            <?php foreach ($alamat as $key): ?>
                                                ...
                                                <td>
                                                    <button class="btn btn-primary text-white mb-2"> <?php echo anchor('admin/alamat/edit_alamat/'.$key->id_alamat,'<font color=white > Ubah </font>'); ?> </button>
                                                    ...
                                                    <button class="btn btn-danger text-white mb-2"> <?php echo anchor('admin/alamat/hapus_alamat/'.$key->id_alamat,'<font color=white > Hapus </font>'); ?> </button>
                                                </td>
                        ...
                        <a class="nav-link page-scroll active btn btn-success" href="<?= base_url("admin/alamat/tambah_alamat/") ?>">Tambah Data</a>
                        </ol>
        </section>
      </div>
      <!-- footer -->
