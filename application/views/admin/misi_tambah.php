		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
                    ...
                    <h1 class="text-center pt-3" style="Margin-top:100px">Tambah Misi</h1>
                    <div class="d-flex align-items-center justify-content-center container row m-auto" style="height: 250px">
                        <form class="col-6" action="<?php echo base_url() . 'admin/Misi/insert'; ?>" method="post">
                            ...
                            <div class="d-flex align-items-center flex-column row">
                                ...
                                <button class="col-5 btn btn-danger text-white rounded rounded-lg mt-3" onclick="window.location.href='/MerapiMas/admin/Misi' ">Kembali</button>
                            </div>
                        </form>
                    </div>
					<!-- Default form register -->
