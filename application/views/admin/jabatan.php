      ...
      <div class="main-content">
        <section class="section">
          ...
          <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" 
                                            ...
                                            <?php foreach ($jabatan as $key): ?>
                                              <?php $no++?>
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-danger text-white mb-2"> <?php echo anchor('admin/jabatan/hapus_jabatan/'.$key->id_jabatan,'<font color=white > Hapus </font>'); ?> </button>
                                                </td>
                        ...
                        <a class="nav-link page-scroll active btn btn-success" href="<?= base_url("admin/jabatan/tambah_jabatan/") ?>">Tambah Data</a>
                        </ol>
        </section>
      </div>
      <!-- footer -->
