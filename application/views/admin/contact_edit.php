		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					...
					<!-- <form class="text-center border border-light p-5" method="post" action="<?php echo base_url() . 'admin/contact/update'; ?>"> -->
					<?php echo form_open_multipart('admin/contact/update'); ?>
						<p class="h4 mb-4">Edit Contact</p>
                        <div class="form-row mb-4">
							<br>
							<small>Id Contact</small>
							<input type="text" class="form-control 
                            form-control-line form-user-input" name="id_contact" id="id_contact" required readonly value="<?php echo $key->id_contact ?>">
							<br><br>
						...
						<div class="form-row mb-4">
							...
							form-control-line form-user-input" name="contact" id="contact" required value="<?php echo $key->contact ?>">
							<br><br>
						...
						<div>
						<img src="<?php echo base_url().'/upload/icon_contact/'. $key->icon ?>" width="100">
						</div>
