      ...
      <div class="main-content">
        <section class="section">
          ...
          <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" 
                                        ...
                                        <?php $no= 0; ?>
                                            <?php foreach ($layanans as $key): ?>
                                              <?php $no++?>
                                                ...
                                                <td>
                                                    <button class="btn btn-primary text-white mb-2"> <?php echo anchor('admin/namalayanan/edit_layanan/'.$key->id_layanan,'<font color=white > Ubah </font>'); ?> </button>
                                                    ...
                                                    <button class="btn btn-danger text-white mb-2"> <?php echo anchor('admin/namalayanan/hapus_layanan/'.$key->id_layanan,'<font color=white > Hapus </font>'); ?> </button>
                                                </td>
                        ...
                        <a class="nav-link page-scroll active btn btn-success" href="<?= base_url("admin/namalayanan/tambah_layanan/") ?>">Tambah Data</a>
                        </ol>
        </section>
      </div>
      <!-- footer -->
